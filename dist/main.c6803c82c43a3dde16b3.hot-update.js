...
function (_React$Component) {
  ...
  function Search(props) {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
      var _this$state, no_bed, no_bath, no_toilets, _this$state$currentAr, lat, lng, mode, _ref2, prices;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$state = _this.state, no_bed = _this$state.tno_bed, no_bath = _this$state.tno_bath, no_toilets = _this$state.tno_toilets, _this$state$currentAr = _this$state.currentArea, lat = _this$state$currentAr.lat, lng = _this$state$currentAr.lng, mode = _this$state.mode;
              _context.next = 3;
...
//# sourceMappingURL=main.c6803c82c43a3dde16b3.hot-update.js.map