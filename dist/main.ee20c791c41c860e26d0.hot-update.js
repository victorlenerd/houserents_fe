  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Search, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
        var _this$state, no_bed, no_bath, no_toilets, _this$state$currentAr, lat, lng, _ref, prices;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$state = this.state, no_bed = _this$state.tno_bed, no_bath = _this$state.tno_bath, no_toilets = _this$state.tno_toilets, _this$state$currentAr = _this$state.currentArea, lat = _this$state$currentAr.lat, lng = _this$state$currentAr.lng;
                _context.next = 3;
...
//# sourceMappingURL=main.ee20c791c41c860e26d0.hot-update.js.map