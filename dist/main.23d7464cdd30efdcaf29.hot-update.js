  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Areas, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
        var _this$state, no_bed, no_bath, no_toilets, _ref, prices;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$state = this.state, no_bed = _this$state.no_bed, no_bath = _this$state.no_bath, no_toilets = _this$state.no_toilets;
                _context.next = 3;
...
//# sourceMappingURL=main.23d7464cdd30efdcaf29.hot-update.js.map