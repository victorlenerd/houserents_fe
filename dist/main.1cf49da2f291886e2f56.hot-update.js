...
function (_React$PureComponent) {
  ...
  function Filter(props) {
    ...
    _this.updateOption = function (e) {
      var name = e.target.name;
      var value = e.target.value;

      _this.setState(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, name, value));
    };
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Filter, [{
    ...
    value: function render() {
      ...
      return (_this$props = this.props).children.apply(_this$props, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(this.state).concat([this.Filter]));
    }
  }, {
...
//# sourceMappingURL=main.1cf49da2f291886e2f56.hot-update.js.map