      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("".concat("http://localhost:5000", "/apartments?offset=").concat(offset, "&limit=").concat(limit), JSON.stringify(body), {
              headers: {
...
//# sourceMappingURL=main.eaaa9fa6267a24ef8ea3.hot-update.js.map